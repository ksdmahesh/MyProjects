...
"m"                        +" or ~9.5 Pm"
        ...
        public ObservableCollection<string> _angle = new ObservableCollection<string>() { "Degree", "Gradian", "Radian" };

        public ObservableCollection<string> _area = new ObservableCollection<string>() { "Acres", "Hectares", "Square centimeter", "Square feet", "Square inch", "Square kilometer", "Square meter", "Square mile", "Square millimeter", "Square yard" };

        public ObservableCollection<string> _base = new ObservableCollection<string>() { "Binary", "Decimal", "Hexa Decimal", "Octal" };

        public ObservableCollection<string> _energy = new ObservableCollection<string>() { "British Thermal Unit", "Calorie", "Electron-volts", "Foot-pound", "Joule", "Kilocalorie", "Kilojoule" };

        public ObservableCollection<string> _length = new ObservableCollection<string>() { "Angstorm", "Centimeter", "Chain", "Fathom", "Feet", "Hand", "Inch", "Kilometer", "Link", "Meter", "Microns", "Mile", "Millimeter", "Nanometer", "Nautical Mile", "PICA", "Rods", "Span", "Yard" };

        public ObservableCollection<string> _power = new ObservableCollection<string>() { "BTU/minute", "Foot-Pound/minute", "Horsepower", "Kilowatt", "Watt" };

        public ObservableCollection<string> _pressure = new ObservableCollection<string>() { "Atmosphere", "Bar", "Kilo Pascal", "Millimeter of mercury", "Pascal", "Pound per square inch(PSI)" };

        public ObservableCollection<string> _temperature = new ObservableCollection<string>() { "Degree Celsius", "Degree Fahrenheit", "Kelvin" };

        public ObservableCollection<string> _time = new ObservableCollection<string>() { "Day", "Hour", "Microsecond", "Millisecond", "Minute", "Second", "Week" };

        public ObservableCollection<string> _velocity = new ObservableCollection<string>() { "Centimeter per second", "Feet per second", "Kilometer per hour", "Knots", "Mach(at std. atm)", "Meter per second", "Miles per hour" };

        public ObservableCollection<string> _volume = new ObservableCollection<string>() { "Cubic centimeter", "Cubic feet", "Cubic inch", "Cubic meter", "Cubic yard", "Fluid ounce (UK)", "Fluid ounce (US)", "Gallon (UK)", "Gallon (US)", "Liter", "Pint (UK)", "Pint (US)", "Quart (UK)", "Quart (US)" };

        public ObservableCollection<string> _weight = new ObservableCollection<string>() { "Carat", "Centigram", "Decigram", "Dekagram", "Gram", "Hectogram", "Kilogram", "Long ton", "Milligram", "Ounce", "Pound", "Short ton", "Stone", "Tonne" };
        
        #endregion

        #region private methods

        private List<object> FindedList(List<object> From, List<object> To, int start, int end, string Method, List<object> _numbersTemp)
        {
            if (Method == "add")
            {
        ...
        private List<object> MathStack(List<object> input)
        {
            double _temp1;
        ...
        public string BODMAS(List<object> _numbersList)
        {
        ...
        public string MeanSquare(List<double> list)
        {
            ...
            resultOut = resultOut / list1.Count;
            return resultOut.ToString();
        }
